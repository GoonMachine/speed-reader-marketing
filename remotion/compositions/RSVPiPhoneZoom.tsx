...
export const RSVPiPhoneZoom: React.FC<RSVPiPhoneZoomProps> = ({
  articleText,
  wpm,
  title,
  ...
  // Progress calculation (use totalWordCount for full article progress)
  const displayWordCount = totalWordCount || words.length;
  const progress = displayWordCount > 0 ? currentWordIndex / displayWordCount : 0;
    ...
    >
      ...
      {!isComplete && (
        ...
        >
          ...
          >
            {currentWordIndex} / {displayWordCount}
          </p>
        </div>
      )}
    </AbsoluteFill>
